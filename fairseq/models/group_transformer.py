...
class TransformerDecoder(GroupIncrementalDecoder):
    """
...
class TransformerLengthPreLayer(nn.Module):
    def __init__(self, args,):
        super().__init__()
        self.output_dim= args.length_pre_dim
        self.output_layer = Linear(args.encoder_embed_dim,args.length_pre_dim)
