...
@register_model('lengthpretransformer')
class LenPreTransformerModel(BaseFairseqModel):
    """
    ...
    def __init__(self,encoder):
        super(LenPreTransformerModel, self).__init__()
    ...
    def build_model(cls, args, task):
        ...
        return LenPreTransformerModel(encoder)

    def forward(self, src_tokens, src_lengths):
        result = self.encoder(src_tokens,src_lengths)['encoder_out']
...
class TransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary,embed_tokens):
        ...
        self.fc2 = Linear(embed_dim,int(embed_dim/2))
        self.final_layer = Linear(int(embed_dim/2),40)
...
@register_model_architecture('lengthpretransformer', 'Len_pre_transformer')
def Len_pre_transformer(args):
